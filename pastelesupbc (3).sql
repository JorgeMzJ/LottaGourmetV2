...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2026 a las 08:53:20
...
(39, '2026-04-09 04:54:09', 170.00, 'test', 'test@gmail.com'),
(40, '2026-04-09 04:58:18', 170.00, 'test', 'test@gmail.com'),
(41, '2026-04-09 04:59:27', 170.00, 'test', 'test@gmail.com'),
(42, '2026-04-09 05:00:03', 195.00, 'test', 'test@gmail.com'),
(43, '2026-04-09 05:03:08', 195.00, 'test', 'test@gmail.com'),
(44, '2026-04-09 05:09:40', 510.00, 'test', 'test@gmail.com'),
(45, '2026-04-09 05:13:09', 495.00, 'test', 'test@gmail.com'),
(46, '2026-04-09 05:58:46', 525.00, 'test', 'test@gmail.com');
...
(36, 5, '2026-04-08 19:25:59', 'Personalizado', '2026-04-09', 'asdwasdwasd', NULL, 1, 'Vainilla', 'Fresa', 'Crema', 'Nuez, Almendra', 390.00),
(37, 5, '2026-04-08 21:55:23', 'Personalizado', '2026-04-30', 'asdwasdwasdwasdwasdwasdwasdwasddwasdwasdwa', NULL, 1, 'Vainilla', 'Fresa', 'Crema', 'Nuez, Almendra, Lactosa', 475.00),
(38, 5, '2026-04-08 22:58:20', 'Personalizado', '2026-04-16', 'Hola', NULL, 1, 'Zanahoria', 'Cajeta', 'Fondant', 'Almendra, Lactosa', 560.00);
...
(3, 'Carlota de Limón', 'Carlota ácida y deliciosa con limón siciliano, mousse ligero y base de vainilla. Toque cítrico irresistible.', 175.00, 7, 'carlota_limon.jpg', 0, NULL),
...
(9, 'Carlota de Café', 'Carlota para los amantes del café con espresso italiano, crema de café y galletitas de chocolate.', 170.00, 7, 'carlota_cafe.jpg', 0, NULL),
...
(14, 'Pastel Selva Negra', 'Pastel multicapas con chocolate, cerezas en almíbar, crema chantilly y virutas de chocolate. Clásico elegante.', 240.00, 6, 'pastel_selva_negra.jpg', 1, 210.00),
...
(16, 'Tarta de Limón', 'Tarta cítrica con limón fresco, buttercream de limón y merengue. Refrescante y aromática.', 195.00, 11, 'pastel_limon.jpg', 1, 135.00),
...
(21, 'Carlota de Frambuesa', 'Elegante carlota con frambuesas frescas, mousse de frambuesa y base de vainilla. Sabor sofisticado y delicado.', 195.00, 7, 'carlota_frambuesa.jpg', 0, NULL),
(22, 'Carlota de Mango', 'Refrescante carlota elaborada con pulpa de mango, crema chantilly y galletas María. Ideal para días calurosos.', 180.00, 19, 'carlota_mango.jpg', 1, 150.00),
...
(24, 'Pedido personalizado', 'Registro de pedido personalizado generado desde Stripe Checkout.', 0.00, 0, NULL, 0, NULL);
...
--
ALTER TABLE `compra_detalles`
  MODIFY `id_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
