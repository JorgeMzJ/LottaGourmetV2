...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2026 a las 15:59:43
...
(30, '2026-02-19 15:47:15', 175.00, 'admin', 'admin@gmail.com'),
(31, '2026-02-19 17:39:37', 620.00, 'Prueba', 'prueba@gmail.com'),
(32, '2026-02-26 16:21:00', 1255.00, 'admin', 'admin@gmail.com'),
(33, '2026-03-06 16:51:12', 1390.00, 'admin', 'admin@gmail.com'),
(34, '2026-04-08 17:44:29', 540.00, 'test', 'test@gmail.com');
...
(24, 2, '2026-02-19 09:38:01', 'Otro', '2026-03-11', 'Hola bro', 7, 0, NULL, NULL, NULL, NULL, NULL),
(25, 4, '2026-02-19 09:40:21', 'Corporativo', '2026-02-20', '', 5, 0, NULL, NULL, NULL, NULL, NULL),
(26, 2, '2026-03-19 08:26:37', 'Boda', '2026-03-27', '', 3, 0, NULL, NULL, NULL, NULL, NULL);
...
(1, 'Carlota de Fresa', 'Deliciosa carlota con fresas frescas, crema pastelera y bizcocho esponjoso. Perfecta para cualquier celebración.', 180.00, 20, 'carlota_fresa.jpg', 0, NULL),
(3, 'Carlota de Limón', 'Carlota ácida y deliciosa con limón siciliano, mousse ligero y base de vainilla. Toque cítrico irresistible.', 175.00, 15, 'carlota_limon.jpg', 0, NULL),
(6, 'Carlota de Piña', 'Tropical carlota con trozos de piña natural, crema de coco y bizcocho húmedo. Sabor del paraíso.', 165.00, 16, 'carlota_pina.jpg', 0, NULL),
(7, 'Carlota de Vainilla', 'Clásica carlota de vainilla con crema pastelera, bizcocho esponjoso y decoración de chispas de chocolate.', 160.00, 23, 'carlota_vainilla.jpg', 0, NULL),
(9, 'Carlota de Café', 'Carlota para los amantes del café con espresso italiano, crema de café y galletitas de chocolate.', 170.00, 16, 'carlota_cafe.jpg', 0, NULL),
(10, 'Carlota de Tres Leches', 'Carlota tipo tres leches con leche condensada, leche evaporada y crema fresca. Clásico reinventado.', 175.00, 15, 'carlota_tres_leches.jpg', 0, NULL),
(11, 'Pastel de Chocolate', 'Esponjoso pastel de chocolate con ganache de chocolate oscuro y cobertura de cacao. Irresistible para chocolateros.', 220.00, 21, 'pastel_chocolate.jpg', 1, 200.00),
(12, 'Pastel de Zanahoria', 'Pastel de zanahoria con nueces, canela y frosting de queso crema. Saludable y delicioso.', 200.00, 15, 'pastel_zanahoria.jpg', 0, NULL),
(13, 'Pastel de Vainilla', 'Suave pastel de vainilla con relleno de crema pastelera y cobertura de buttercream. Perfecto para cualquier ocasión.', 190.00, 25, 'pastel_vainilla.jpg', 0, NULL),
...
(15, 'Pastel de Red Velvet', 'Pastel rojo terciopelado con frosting de queso crema, frambuesas y decoración de pétalos comestibles.', 210.00, 14, 'pastel_red_velvet.jpg', 0, NULL),
(16, 'Tarta de Limón', 'Tarta cítrica con limón fresco, buttercream de limón y merengue. Refrescante y aromática.', 195.00, 17, 'pastel_limon.jpg', 0, NULL),
(17, 'Pastel de Café Moca', 'Pastel capas con café, chocolate y crema mocha. Ideal para después de comidas.', 215.00, 16, 'pastel_moca.jpg', 0, NULL),
(19, 'Tarta Frutos Rojos', 'Tarta con capas de bizcocho vainilla, crema chantilly y mezcla de frutos rojos frescos. Colorido y delicioso.', 220.00, 15, 'pastel_frutos_rojos.jpg', 0, NULL),
(20, 'Pastel de Dulce de Leche', 'Pastel clásico relleno de dulce de leche casero, merengue y crocante de nueces. Caramelo puro.', 200.00, 4, 'pastel_dulce_leche.jpg', 0, NULL),
(21, 'Carlota de Frambuesa', 'Elegante carlota con frambuesas frescas, mousse de frambuesa y base de vainilla. Sabor sofisticado y delicado.', 195.00, 5, 'carlota_frambuesa.jpg', 1, 155.00),
(22, 'Carlota de Mango', 'Refrescante carlota elaborada con pulpa de mango, crema chantilly y galletas María. Ideal para días calurosos.', 170.00, 17, 'carlota_mango.jpg', 0, NULL),
(23, 'Carlota de Maracuyá', 'Exótica carlota con maracuyá fresco, mousse ligero y bizcocho de vainilla. Sabor tropical irresistible.', 185.00, 12, 'carlota_maracuya.jpg', 1, 160.00),
...
(4, 'Prueba', 'prueba@gmail.com', '1234567890', '$2y$10$FCI7zB8figFQdqWH4MW4MuQ.AbtEcbCW3gJLBPF8LCWvOBf4WtzYm', 0, '2026-02-19 09:39:12'),
(5, 'Juan Perez', 'juan@lottagourmet.com', '5512345678', 'hash_seguro_123', 0, '2026-03-24 08:08:19'),
(6, 'Test largo', 'largo@mail.com', '123456789012345678901234567890', 'pass', 0, '2026-03-24 08:18:46'),
(8, 'test', 'test@gmail.com', '6861234567', '$2y$10$OmwQJVej5iqCLfst5isdqexzQQax7UvyOJGHMlNTDxjHHntdIrbAa', 0, '2026-04-07 09:41:01');
